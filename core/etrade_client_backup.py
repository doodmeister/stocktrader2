...
class ETradeClient:
    ...
    def _load_accounts(self) -> None:
        ...
        try:
            ...
            # Note: Official examples use header_auth=True but this may be version specific
            ...
            if response is not None and response.status_code == 200:
                ...
                if (data is not None and 
                    ...
                    # Filter closed accounts following accounts.py                    self.accounts = [acc for acc in accounts if acc.get('accountStatus') != 'CLOSED']
